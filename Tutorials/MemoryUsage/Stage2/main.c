...
// solves the memory leak introduced in Stage1: it frees the user data and the
// node when the button to erase the last node is pressed. In Stage1 only the
// memory allocated for the node was freed.
//
